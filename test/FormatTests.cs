...
namespace Tavenem.Time.Test
{
    ...
    public class FormatTests
    {
        ...
        public void ToStringTest()
        {
            ...
            Assert.AreEqual("1 2", value.ToString("D"));
            Assert.AreEqual("1 2 03:04:05:006:007:008:009:010:011:012:013:14.2", value.ToString("E"));
            ...
            Assert.AreEqual("1-183845006007008:9010011012013:14.15", value.ToString("o"));
            Assert.AreEqual("03:04", value.ToString("t"));
            Assert.AreEqual("03:04:05", value.ToString("T"));
            Assert.AreEqual("1 y 2 d 3 h 4 min 5 s 6 ms 7 μs 8 ns 9 ps 10 fs 11 as 12 zs 13 ys 14.15 tP", value.ToString("X"));
