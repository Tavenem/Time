...
public partial struct RelativeDuration
{
    ...
    /// <remarks>
    /// Note that if the total exceeds <see cref="double.MaxValue"/>, this method
    /// may return <see cref="double.PositiveInfinity"/> even for a <see
    /// cref="RelativeDuration"/> for which <see cref="IsPerpetual"/> is <see
    /// langword="false"/>.
    /// </remarks>
    public double ToAeons(Duration localYear, Duration localDay)
    ...
    /// langword="false"/>.
    /// </remarks>
    public double ToAttoseconds(Duration localYear, Duration localDay)
    ...
    /// langword="false"/>.
    /// </remarks>
    public double ToDays(Duration localYear, Duration localDay)
    ...
    /// langword="false"/>.
    /// </remarks>
    public double ToFemtoseconds(Duration localYear, Duration localDay)
    ...
    /// langword="false"/>.
    /// </remarks>
    public double ToHours(Duration localYear, Duration localDay)
    ...
    /// langword="false"/>.
    /// </remarks>
    public double ToMicroseconds(Duration localYear, Duration localDay)
    ...
    /// langword="false"/>.
    /// </remarks>
    public double ToMilliseconds(Duration localYear, Duration localDay)
    ...
    /// langword="false"/>.
    /// </remarks>
    public double ToMinutes(Duration localYear, Duration localDay)
    ...
    /// langword="false"/>.
    /// </remarks>
    public double ToNanoseconds(Duration localYear, Duration localDay)
    ...
    /// langword="false"/>.
    /// </remarks>
    public double ToPicoseconds(Duration localYear, Duration localDay)
    ...
    /// langword="false"/>.
    /// </remarks>
    public double ToPlanckTime(Duration localYear, Duration localDay)
    ...
    /// langword="false"/>.
    /// </remarks>
    public double ToSeconds(Duration localYear, Duration localDay)
    ...
    /// langword="false"/>.
    /// </remarks>
    public double ToYears(Duration localYear, Duration localDay)
    ...
    /// langword="false"/>.
    /// </remarks>
    public double ToYoctoseconds(Duration localYear, Duration localDay)
    ...
    /// langword="false"/>.
    /// </remarks>
    public double ToZeptoseconds(Duration localYear, Duration localDay)
