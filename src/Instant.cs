...
namespace Tavenem.Time
{
        ...
        ISerializable
    {
        ...
        private Instant(SerializationInfo info, StreamingContext context) : this(
            (Duration?)info.GetValue(nameof(Offset), typeof(Duration)) ?? default,
            (int?)info.GetValue(nameof(Epoch), typeof(int)) ?? default)
        { }
