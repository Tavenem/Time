...
namespace Tavenem.Time
{
    public partial struct RelativeDuration : IFormattable
    {
        ...
        /// </para>
        /// </remarks>
        public string ToString(string? format) => DurationFormatProvider.Instance.Format(format, this, DurationFormatProvider.Instance);
        ...
        /// </remarks>
        public override string ToString() => DurationFormatProvider.Instance.Format(DurationFormatProvider.DefaultFormat, this, DurationFormatProvider.Instance);
    }
}
