...
namespace Tavenem.Time
{
    public partial struct RelativeDuration
    {
        ...
        public static RelativeDuration Parse(string? s, IFormatProvider provider)
        {
            if (s is null)
            {
        ...
        public static RelativeDuration Parse(in ReadOnlySpan<char> s, IFormatProvider provider)
        {
        ...
        /// contains only white space, contains invalid <see cref="RelativeDuration"/> data, or the format
        /// cannot be determined.</exception>
        public static RelativeDuration Parse(string? s) => Parse(s, DurationFormatProvider.Instance);
        ...
        /// space, contains invalid <see cref="RelativeDuration"/> data, or the format cannot be
        /// determined.</exception>
        public static RelativeDuration Parse(in ReadOnlySpan<char> s) => Parse(s, DurationFormatProvider.Instance);
        ...
        /// determined.</exception>
        public static RelativeDuration ParseExact(string? s, string format, IFormatProvider provider)
        {
            if (s is null)
            {
                throw new ArgumentNullException(nameof(s));
        ...
        public static RelativeDuration ParseExact(in ReadOnlySpan<char> s, in ReadOnlySpan<char> format, IFormatProvider provider)
        {
            if (TryParseRelativeDuration(s, out var result))
            {
                return result;
        ...
        /// invalid <see cref="RelativeDuration"/> data, or the format cannot be
        /// determined.</exception>
        public static RelativeDuration ParseExact(string? s, string format)
            => ParseExact(s, format, DurationFormatProvider.Instance);
        ...
        /// empty, or <paramref name="s"/> contains only white space, contains invalid <see
        /// cref="RelativeDuration"/> data, or the format cannot be determined.</exception>
        public static RelativeDuration ParseExact(in ReadOnlySpan<char> s, in ReadOnlySpan<char> format)
            => ParseExact(s, format, DurationFormatProvider.Instance);
        ...
        /// <remarks>
        /// <para>
        /// The <see cref="TryParse(in ReadOnlySpan{char}, IFormatProvider, out RelativeDuration)"/> method is
        /// similar to the <see cref="Parse(in ReadOnlySpan{char}, IFormatProvider)"/> method, except
        /// that the <see cref="TryParse(in ReadOnlySpan{char}, IFormatProvider, out RelativeDuration)"/>
        ...
        /// </para>
        /// </remarks>
        public static bool TryParse(in ReadOnlySpan<char> s, IFormatProvider provider, out RelativeDuration result)
        {
        ...
        public static bool TryParse(string? s, out RelativeDuration result)
            => TryParse(s, DurationFormatProvider.Instance, out result);
        ...
        /// <remarks>
        /// <para>
        /// The <see cref="TryParse(in ReadOnlySpan{char}, out RelativeDuration)"/> method is similar to the
        /// <see cref="Parse(in ReadOnlySpan{char})"/> method, except that the <see
        /// cref="TryParse(in ReadOnlySpan{char}, out RelativeDuration)"/> method does not throw an exception
        ...
        /// </para>
        /// </remarks>
        public static bool TryParse(in ReadOnlySpan<char> s, out RelativeDuration result)
            => TryParse(s, DurationFormatProvider.Instance, out result);
        ...
        /// cref="ParseExact(in ReadOnlySpan{char}, in ReadOnlySpan{char}, IFormatProvider)"/> method,
        /// except that the <see cref="TryParseExact(in ReadOnlySpan{char}, in ReadOnlySpan{char},
        ...
        /// </para>
        /// </remarks>
        public static bool TryParseExact(in ReadOnlySpan<char> s, in ReadOnlySpan<char> format, IFormatProvider provider, out RelativeDuration result)
        {
            if (TryParseRelativeDuration(s, out result))
            {
                return true;
        ...
        public static bool TryParseExact(string? s, string format, out RelativeDuration result)
            => TryParseExact(s, format, DurationFormatProvider.Instance, out result);
        ...
        /// <remarks>
        /// <para>
        /// The <see cref="TryParseExact(in ReadOnlySpan{char}, in ReadOnlySpan{char}, out
        /// RelativeDuration)"/>
        /// method is similar to the <see cref="ParseExact(in ReadOnlySpan{char},
        /// in ReadOnlySpan{char})"/> method, except that the <see
        /// cref="TryParseExact(in ReadOnlySpan{char}, in ReadOnlySpan{char}, out RelativeDuration)"/>
        /// method does not throw an exception if the conversion fails.
        /// </para>
        /// <para>
        /// Only recognized formats can be parsed successfully. Even recognized formats may not
        ...
        /// </para>
        /// </remarks>
        public static bool TryParseExact(in ReadOnlySpan<char> s, in ReadOnlySpan<char> format, out RelativeDuration result)
            => TryParseExact(s, format, DurationFormatProvider.Instance, out result);

        private static bool TryParseRelativeDuration(in ReadOnlySpan<char> s, out RelativeDuration result)
        {
            result = Zero;
            double proportion;
