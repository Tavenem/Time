...
namespace Tavenem.Time
{
    public partial struct Duration : IFormattable
    {
        ...
        /// HH:mm:ss:MMM:uuu:nnn:ppp:fff:aaa:zzz:YYY:PPP" custom format string.</description>
        /// </item>
        /// <item>
        /// <term>"f"</term>
        ...
        /// <item>
        /// <term>"O", "o"</term>
        /// <description>Round trip format. Corresponds to the "e'-'n':'Y':'P" custom format
        /// string. Because the length of certain segments varies (unavoidably, to prevent strings
        /// from being longer than <see cref="int.MaxValue"/> to account for <see cref="Duration"/>
        /// instances with the maximum number of aeons), this format is unsuitable for
        /// sorting.</description>
        /// </item>
        /// <item>
        /// <term>"t"</term>
        ...
        /// <description>
        /// <para>
        /// Extensible format. Corresponds to the "e' y 'd' d 'H' h 'm' min 's' s 'M' ms 'u' μs 'n'
        ...
        /// 29 (or 1) should be used to round-trip.
        /// </description>
        /// </item>
        /// <item>
        /// <term>"s", "ss"</term>
        ...
        /// </para>
        /// </remarks>
        public string ToString(string? format, IFormatProvider? formatProvider) => DurationFormatProvider.Instance.Format(format, this, formatProvider);
        ...
        /// </exception>
        public string ToString(IFormatProvider? formatProvider) => DurationFormatProvider.Instance.Format(DurationFormatProvider.DefaultFormat, this, formatProvider);
        ...
        /// </para>
        /// </remarks>
        public string ToString(string? format) => DurationFormatProvider.Instance.Format(format, this, CultureInfo.CurrentCulture);

        /// <summary>
        /// <para>
        /// Converts the value of the current <see cref="Duration"/> object to its equivalent string
        /// representation using the default format and current culture.
        /// </para>
        /// <para>
        /// A perpetual <see cref="Duration"/> is represented with the infinity symbol ("∞")
        /// regardless of format.
        /// </para>
        /// </summary>
        public override string ToString() => DurationFormatProvider.Instance.Format(DurationFormatProvider.DefaultFormat, this, CultureInfo.CurrentCulture);
    }
}
